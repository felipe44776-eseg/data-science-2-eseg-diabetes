...
:root{
  ...
  --realce:#f2f1ed;
  /* #8a8880 dava 3,46:1 sobre o fundo claro — abaixo do minimo de 4,5:1 do
     WCAG AA, e e a cor de toda nota e legenda de tabela. Medido com Puppeteer. */
  --tinta3:#706e68;
  /* o rotulo de secao e azul a 12px: #2a78d6 da 4,30:1. So o texto
     escurece; as barras e links seguem com --s1. */
  --olho:#1f6ac4;
}
...
.olho{font-size:12px;letter-spacing:.14em;text-transform:uppercase;color:var(--olho);
