...
:root{color-scheme:light dark;
  /* --ink3 e a cor de todo rotulo secundario: h2 de secao, cabecalho de tabela
     e nota de campo. #898781 dava 3,50:1 sobre o cartao claro, abaixo do minimo
     de 4,5:1 do WCAG AA. Medido com Puppeteer no HTML publicado. */
  --bg:#f9f9f7; --card:#fcfcfb; --ink:#0b0b0b; --ink2:#52514e; --ink3:#706e68;
