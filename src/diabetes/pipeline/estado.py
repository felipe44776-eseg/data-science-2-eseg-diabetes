...
ETAPAS: list[Etapa] = [
    ...
    Etapa(
        ...
        ("data/processed/gold/brfss_expandido.parquet",
         ...
         "data/processed/gold/_validacao_temporal.json",
         "data/external/brfss2015/_analise_vies.json",
         "reports/produto/modelo.json", "src/diabetes/produto/metodo.py"),
        ("reports/metodo/index.html",),
        nota="matriz de confusao calculada com as tabelas servidas ao usuario",
    ),
    Etapa(
